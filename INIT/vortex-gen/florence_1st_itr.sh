...
HBL=/projects/ees/dhs-crc/mjisan/HBL_V_DEV3/INIT
DIR1=$HBL/boundary_parametric/FLORENCE/exps/2KM/INPUT           #Input directory for parametric run
DIR2=$HBL/vortex_gen                                             #Location of scaling code
DIR3=$HBL/boundary_parametric/FLORENCE/exps/2KM                 #Model run directory
DIR4=$HBL/boundary_model/FLORENCE/exps/2KM/INPUT                #Input directory for model run
DIR5=$HBL/boundary_model/FLORENCE/exps/2KM                      #Model root directory
DIR6=$HBL/vortex_gen/FLORENCE/vortex_gen_out/OUTPUT              #Path of saved outputs from initalization run
